...
var require_url_state_machine = __commonJS({
    "node_modules/whatwg-url/lib/url-state-machine.js"(exports, module2) {
        ...
        function isWindowsDriveLetterString(string) {
            return (
                string.length === 2 && isASCIIAlpha(string.codePointAt(0)) && (string[1] === ":" || string[1] === "|")
            );
        }
    ...
    "node_modules/node-fetch/lib/index.js"(exports, module2) {
        ...
        var Request = class {
            constructor(input) {
                ...
                this.compress =
                    init.compress !== void 0 ? init.compress : input.compress !== void 0 ? input.compress : true;
...
var getChangedFiles = async () => {
    ...
    await (0, import_exec.exec)(
        ...
        [
            "diff",
            "--name-only",
            `origin/${(_a = import_github.context.payload.pull_request) == null ? void 0 : _a.base.ref}`,
        ],
        {
            listeners: {
